...
```
git clone https://github.com/darkboss1/darkboss1_Social_Hacking_Toolkit.git

cd darkboss1_Social_Hacking_Toolkit
...
# extract zip file and open terminal into "darkboss1_Social_Hacking_Toolkit" folder
